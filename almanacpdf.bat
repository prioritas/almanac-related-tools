...
:: set /p SS=1 page Portrait [1], 1 page Landscape [2], 2 pages Portrait [3] ^> 
set SS=3
if [%SS%] == [1] (
  set XSL_STYLESHEET=.\data2fop.xsl
) else if [%SS%] == [2] (
  set XSL_STYLESHEET=.\data2fop_landscape.xsl
) else if [%SS%] == [3] (
