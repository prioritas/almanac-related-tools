...
public class LunarDistanceSample_01
{
  ...
  private static String[] sunAlt  = new String[] { "47", "48" };
  private static String[] moonAlt = new String[] { "47", "12.8" };

  private static String[] distDM  = new String[] { "80", "8.6" };

  private static int[] sunHMS  = new int[] { 20, 11, 14 };
  private static int[] distHMS = new int[] { 20, 16, 37 };
  private static int[] moonHMS = new int[] { 20, 17, 57 };
  
  private static double eye = 10 * 0.3048; // 10 feet, in meters
  ...
  public static void main(String[] args)  
  {
    ...
    try
    {
      ...
      // In fact, just parallax & refraction     
